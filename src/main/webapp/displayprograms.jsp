				    ...
				    <table>
				        <thead>
				            <tr style="color:white;">
				                ...
				                <th style="background-color:black;">Speech Time</th>
				                <th style="background-color:black;">SMS</th>
				                <th style="background-color:black;">Data</th>
				                <th style="background-color:black;">Cost</th>
				        ...
				        <tbody>
				            <c:forEach var="program" items="${programs}">
				                <tr>
				                    ...
				                    <td>${program.speechTime} minutes</td>
				                    <td>${program.smsNumber} SMS</td>
				                    <td>${program.dataNumber} Mb</td>
				                    <td>${program.cost} &#8364</td>
